...
class CardinaMobile {
    ...
    // Switch to Visa Data Center on 28 Oct 2026 00:00:00 UTC (24h safety buffer after Phase 1 begins)
    private static let visaCutoverDate = ISO8601DateFormatter().date(from: "2026-10-28T00:00:00Z")!
